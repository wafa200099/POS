...
function EditableRow({editFormData,handleEditFormChange,handleCancelClick,handleEditFormSubmit}) {
  return (
  <tr>
    ...
    <td><input type="text" required="required" placeholder='Please Enter category' name='category' value={editFormData.category} onChange={handleEditFormChange}/></td>
    ...
    <button type='submit' handleEditFormSubmit={ handleEditFormSubmit} class="btn btn-outline-primary p-1 m-1">Save</button>
